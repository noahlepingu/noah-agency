...
| 4     | Qualite (QA, accessibilite/perf, securite) | FAIT (QA FAIT ; accessibilite/perf FAIT ; securite FAIT — verdict OK SOUS CONDITIONS → C-01..C-09 levees) | QA / Specialists |
